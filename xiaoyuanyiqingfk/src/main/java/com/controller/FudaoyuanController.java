    ...
    */
    ...
    public R save(@RequestBody FudaoyuanEntity fudaoyuan, HttpServletRequest request){
        ...
        if(fudaoyuanEntity==null){
            ...
            fudaoyuan.setInsertTime(new Date());
...
//                            fudaoyuanEntity.setFudaoyuanName(data.get(0));                    //辅导员名称 要改的
...
//                            fudaoyuanEntity.setFudaoyuanEmail(data.get(0));                    //辅导员邮箱 要改的
//                            fudaoyuanEntity.setFudaoyuanDelete(1);//逻辑删除字段
//                            fudaoyuanEntity.setInsertTime(date);//时间
