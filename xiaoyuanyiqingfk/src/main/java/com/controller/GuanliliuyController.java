    ...
    */
    ...
    public R save(@RequestBody GuanliliuyEntity guanliliuy, HttpServletRequest request){
        ...
        Wrapper<GuanliliuyEntity> queryWrapper = new EntityWrapper<GuanliliuyEntity>()
            ...
            .eq("guanliliuy_name", guanliliuy.getGuanliliuyName())
            .eq("sex_types", guanliliuy.getSexTypes())
            .eq("guanliliuy_types", guanliliuy.getGuanliliuyTypes())
            .eq("yuanxi_types", guanliliuy.getYuanxiTypes())
...
//                            guanliliuyEntity.setYonghuId(Integer.valueOf(data.get(0)));   //防疫人员 要改的
//                            guanliliuyEntity.setGuanliliuyName(data.get(0));                    //姓名 要改的
//                            guanliliuyEntity.setSexTypes(Integer.valueOf(data.get(0)));   //性别 要改的
//                            guanliliuyEntity.setGuanliliuyTypes(Integer.valueOf(data.get(0)));   //身份 要改的
//                            guanliliuyEntity.setYuanxiTypes(Integer.valueOf(data.get(0)));   //院系 要改的
//                            guanliliuyEntity.setGuanliliuyTiwen(data.get(0));                    //当天体温 要改的
